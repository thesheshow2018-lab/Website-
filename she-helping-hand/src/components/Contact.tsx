...
export default function Contact() {
  const contactInfo = [
    { icon: Mail, label: "Email Us", value: "shehelpinghand@gmail.com", sub: "Primary Contact" },
    { icon: Mail, label: "Email Us", value: "the.she.show.2018@gmail.com", sub: "Secondary Contact" },
    { icon: Phone, label: "Call Us", value: "050 369 5656", sub: "Available 24/7" },
