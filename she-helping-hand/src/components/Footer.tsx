...
export default function Footer({ onDonateClick }: { onDonateClick: () => void }) {
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li><button onClick={onDonateClick} className="hover:text-primary transition-colors text-left w-full">Make a Donation</button></li>
