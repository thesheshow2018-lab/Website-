...
export default function CTA({ onDonateClick }: { onDonateClick: () => void }) {
  return (
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button 
                ...
                className="px-10 py-5 bg-white text-primary hover:bg-gray-100 rounded-2xl font-bold text-lg shadow-2xl transition-all hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3"
              >
                Support Our Mission
